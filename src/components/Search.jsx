      ...
      <div className='mb-16 mt-16' >
        <div className="bg-[#A3E635] border-4 border-black px-6 py-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            type="text"
             ...
             />
           <button
            className="h-14 md:h-16 px-6 md:px-8 bg-black text-white font-bold text-lg md:text-xl border-4 border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-white hover:text-black transition-all whitespace-nowrap">
             SEARCH USER
           </button>
